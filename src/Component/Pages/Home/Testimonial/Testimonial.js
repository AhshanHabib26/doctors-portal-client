        ...
        <div className=" grid grid-cols-1 lg:grid-cols-3 gap-5">
          <div className="card w-96 bg-base-100 shadow-xl">
            <div className="card-body">
              ...
              <h2 className="card-title text-accent">Ahshan Habib</h2>
          ...
          <div className="card w-96 bg-base-100 shadow-xl">
            <div className="card-body">
              <p className=" text-justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque quidem quo veritatis ipsam! Natus id minus, culpa modi amet assumenda?</p>
              <div className="card-actions flex flex-col justify-start">
              <h2 className="card-title text-accent">Abu Yousuf</h2>
              <p className="text-accent text-md mt-[-8px]">Bangladesh</p>
              </div>
            </div>
          </div>
          <div className="card w-96 bg-base-100 shadow-xl">
            <div className="card-body">
              <p className=" text-justify">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Cumque quidem quo veritatis ipsam! Natus id minus, culpa modi amet assumenda?</p>
              <div className="card-actions flex flex-col justify-start">
              <h2 className="card-title text-accent">Rony Prodhan</h2>
              <p className="text-accent text-md mt-[-8px]">Bangladesh</p>
              </div>
            </div>
          </div>
